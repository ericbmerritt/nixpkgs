...
with haskellPackages; mkDerivation {
  pname = "infpipe";
  version = "0.0.5+build.14.gf02bb3a";
  src = sunlight.fetch {name = "infpipe";version = "0.0.5+build.14.gf02bb3a"; sha256 = "0cy3837dl4vpmvrqah1ygraii5w9sdkgqij3fqwrvgswqdnjqk16";};
  isLibrary = false;
  isExecutable = true;
  dontStrip = true;
