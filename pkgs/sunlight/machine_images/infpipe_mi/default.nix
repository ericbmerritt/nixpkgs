...
stdenv.mkDerivation rec {
  name = "infpipe_mi";
  version = "0.0.0+build.57.gd17cd11";

  src = sunlight.fetch {name = "infpipe_mi";version = "0.0.0+build.57.gd17cd11"; sha256 = "1m8w77dc2wxrrz35iay67zk03dkxlhfa733vb85830vzbyzzh2ny";};
