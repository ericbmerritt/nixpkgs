...
stdenv.mkDerivation rec {
  name = "infpipe_mi";
  version = "0.0.0+build.68.g6d28b32";

  src = sunlight.fetch {name = "infpipe_mi";version = "0.0.0+build.68.g6d28b32"; sha256 = "1ncz5f76j7l8sj8jqim2fb0rc6f4ix19kzgxpjihpy9v4d7nsm4p";};
