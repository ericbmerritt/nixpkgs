...
stdenv.mkDerivation rec {
  name = "infpipe_mi";
  version = "0.0.0+build.55.g2ea3f94";

  src = sunlight.fetch {name = "infpipe_mi";version = "0.0.0+build.55.g2ea3f94"; sha256 = "16yb1y32lax8qcviiyzc2vs8wj3jyvz8sarxr2dc5q2nklhijw7z";};
