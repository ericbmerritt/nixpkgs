...
stdenv.mkDerivation rec {
  name = "infpipe_mi";
  version = "0.0.0+build.70.gc7abc2e";

  src = sunlight.fetch {name = "infpipe_mi";version = "0.0.0+build.70.gc7abc2e"; sha256 = "0i2cjl9vbaw3hkwgd4kschcbbq8rld064m8b0xkby898znbl7gva";};
